...
use App\Models\User;
use App\useCases\SocialiteService;
...
class SocialLoginController extends Controller
{
     ...
     */
    public function __construct(SocialiteService $socialiteService, SocialiteHelper $socialiteHelper)
    {
    ...
    public function login(Request $request, $provider)
    {
        ...
        try {
            $user = $this->socialiteService->findOrCreateProvider($this->getProviderUser($provider), $provider);
